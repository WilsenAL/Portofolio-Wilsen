...
var DismissableLayerBranch = React7.forwardRef(__name8(function DismissableLayerBranch2(props, forwardedRef) {
  const context = React7.useContext(DismissableLayerContext);
...
var ToastProvider = __name14((props) => {
  const {
    __scopeToast,
    label = "Notification",
    duration = 5e3,
...
var ToastViewport = React14.forwardRef(
  __name14(function ToastViewport2(props, forwardedRef) {
    const {
      __scopeToast,
    ...
    React14.useEffect(() => {
      const handleKeyDown = __name14((event) => {
    ...
    React14.useEffect(() => {
      ...
      if (hasToasts && wrapper && viewport) {
        ...
        const handleFocusOutResume = __name14((event) => {
          const isFocusMovingOutside = !wrapper.contains(event.relatedTarget);
          if (isFocusMovingOutside) handleResume();
        }, "handleFocusOutResume");
        const handlePointerLeaveResume = __name14(() => {
...
var FocusProxy = React14.forwardRef(
  // blank line to reduce diff noise
  __name14(function ToastFocusProxy(props, forwardedRef) {
...
var Toast = React14.forwardRef(
  // blank line to reduce diff noise
  __name14(function Toast2(props, forwardedRef) {
...
var ToastImpl = React14.forwardRef(
  __name14(function ToastImpl2(props, forwardedRef) {
    const {
      __scopeToast,
      type = "foreground",
...
var ToastAnnounce = __name14((props) => {
...
var ToastTitle = React14.forwardRef(
  __name14(function ToastTitle2(props, forwardedRef) {
...
var ToastDescription = React14.forwardRef(
  // blank line to reduce diff noise
  __name14(function ToastDescription2(props, forwardedRef) {
...
var ToastAction = React14.forwardRef(
  __name14(function ToastAction2(props, forwardedRef) {
...
var ToastClose = React14.forwardRef(
  __name14(function ToastClose2(props, forwardedRef) {
...
var ToastAnnounceExclude = React14.forwardRef(__name14(function ToastAnnounceExclude2(props, forwardedRef) {
...
__name14(getAnnounceTextContent, "getAnnounceTextContent");
...
__name14(handleAndDispatchCustomEvent2, "handleAndDispatchCustomEvent");
var isDeltaInDirection = __name14((delta, direction, threshold = 0) => {
...
__name14(useNextFrame, "useNextFrame");
function isHTMLElement(node) {
  return node.nodeType === node.ELEMENT_NODE;
}
__name14(isHTMLElement, "isHTMLElement");
function getTabbableCandidates(container) {
  const nodes = [];
  const walker = document.createTreeWalker(container, NodeFilter.SHOW_ELEMENT, {
    acceptNode: __name14((node) => {
